...
<div class="modal-dark-bg dark-bg">
<!-- форма -->
	...
	<div class="modal big-modal" id="consult-form">
		<button class="btn btn-icon btn-close btn-close-modal"><svg class="icon"><use xlink:href="#close"/></svg></button>
		<div class="modal-inner">
			<div class="order-form-box container">
				<form novalidate>
	...
	<!-- ответ формы -->
	<div class="modal big-modal" id="success-form">
		<button class="btn btn-icon btn-close btn-close-modal"><svg class="icon"><use xlink:href="#close"/></svg></button>
	...
	<!-- /ответ форм -->
	<!-- тренды -->
	<div class="modal medium-modal" id="trends">
		<button class="btn btn-icon btn-close btn-close-modal"><svg class="icon"><use xlink:href="#close"/></svg></button>
		<div class="modal-inner">
